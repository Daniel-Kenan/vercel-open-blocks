...
export default function VersionComparison({ version1, version2, onClose, onRestore }: VersionComparisonProps) {
    ...
    <div className={`h-full flex flex-col ${isFullscreen ? "fixed inset-0 z-50 bg-background" : ""}`}>
      ...
      <div className="flex items-center justify-between p-4 bg-muted/30">
        <div className="flex items-center gap-4">
          <div>
            <div className="text-sm font-medium">From: Version {version1.number}</div>
          ...
          <div>
            <div className="text-sm font-medium">To: Version {version2.number}</div>
            <div className="text-xs text-muted-foreground">
        ...
        <div className="flex gap-2">
          <Button size="sm" variant="outline" onClick={() => handleRestore(version1.id)}>
            Restore {version1.number}
          </Button>
          <Button size="sm" onClick={() => handleRestore(version2.id)}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="nodes" className="flex-1 p-4 overflow-hidden flex">
          <div className="w-1/2 pr-2 space-y-4 overflow-auto">
            {nodeChanges.map((change) => (
              <div
                key={change.id}
        ...
        <TabsContent value="config" className="flex-1 p-4 overflow-hidden flex">
          <div className="w-1/2 pr-2 space-y-4 overflow-auto">
            {configChanges.map((change) => (
              <div
                key={change.id}
